    ...
    <main class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex flex-wrap gap-3 text-sm">
                    <span class="px-3 py-1 bg-red-100 text-red-800 rounded-full">HIGH: &gt;150 (Risk of price crash)</span>
                    <span class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full">MEDIUM: 100-150 (Monitor closely)</span>
                    <span class="px-3 py-1 bg-green-100 text-green-800 rounded-full">LOW: &lt;100 (Healthy market)</span>
                </div>
            </div>
        </div>
            ...
            <form method="POST" class="flex flex-wrap items-end gap-4">
                <div class="flex-1 min-w-[250px]">
                    ...
                    >
                        ...
                        <option 
                            value="<?= $crop['crop_id'] ?>"
                            <?= $filterCrop == $crop['crop_id'] ? 'selected' : '' ?>
                        >
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 text-center border-l-4 border-blue-500">
                ...
                <p class="text-xs text-gray-400">quintals/farmer</p>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium <?= $levelClass ?>">

...
<body class="bg-gray-100 min-h-screen">
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-green-200">Farmer Portal</p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right">
                        ...
                        <p class="text-xs text-green-200">Verified Farmer</p>
                    </div>
                    <a href="update_crop.php?logout=1"
                        class="bg-green-800 hover:bg-green-900 px-3 py-2 rounded-lg text-sm font-medium transition-colors">
                        Exit
                    </a>
                </div>
            </div>
    ...
    <main class="max-w-2xl mx-auto px-4 py-8">
        ...
        <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-gray-800">Submit Crop Supply</h2>
            <p class="text-gray-500 mt-1">Enter your crop supply details for the market</p>
        </div>
        ...
        <?php if ($success): ?>
            ...
            <div class="flex gap-4">
                <a href="update_crop.php"
                    class="flex-1 text-center bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors">
                    Submit Another
                </a>
                <a href="/agrisense/index.php"
                    class="flex-1 text-center bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-3 px-4 rounded-lg transition-colors">
                    Go to Dashboard
                </a>
            </div>
        <?php else: ?>
                ...
                <form method="POST" action="" novalidate>
                    ...
                    <div class="mb-5">
                        ...
                        <select id="crop_id" name="crop_id"
                            class="w-full px-4 py-3 border <?= isset($errors['crop']) ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition bg-white">
                    ...
                    <div class="mb-5">
                        ...
                        <select id="market_id" name="market_id"
                            class="w-full px-4 py-3 border <?= isset($errors['market']) ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition bg-white">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="quantity" name="quantity" step="0.01" min="0.01"
                                ...
                                class="w-full px-4 py-3 border <?= isset($errors['quantity']) ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition"
                                placeholder="e.g., 50">
                        ...
                        <div>
                            ...
                            <input type="number" id="price_per_unit" name="price_per_unit" step="0.01" min="0.01"
                                ...
                                class="w-full px-4 py-3 border <?= isset($errors['price']) ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition"
